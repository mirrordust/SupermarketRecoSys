...
#
#
# def feature_and_label(feature_df, label_df, subsample, label_first_date, datedelta_slots, svd=False):
#     # 目标顾客
...
#     training_data, training_label = feature_and_label(df_tr_feature, df_tr_label, subsample, training_first_date,
#                                                       utils.datedelta_slots_2_weeks)
#
#     if save_rootdir is not None:
...
#     testing_data, testing_label = feature_and_label(df_te_feature, df_te_label, subsample, testing_first_date,
#                                                     utils.datedelta_slots_2_weeks)
#
#     if save_rootdir is not None:
